...
export default function Hero() {
    ...
    return (<>
        <div className={`fixed top-0 bottom-0 left-0 right-0 bg-red-100  ${hovered ? 'z-1' : 'opacity-0 z-[-1]'} transition-opacity 
        ...
        <span className="items-center justify-center flex flex-col pop-huge z-2"

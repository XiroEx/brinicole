...
export default function Hero() {
    ...
    return (<>
        <div className={`fixed top-0 bottom-0 left-0 right-0 bg-red-100  ${hovered || active ? 'z-1' : 'opacity-0 z-[-1]'} transition-opacity duration-500 ease-in-out pt-[416px] md:pt-128 px-12`}
        ...
        <span className={`items-center justify-center flex flex-col z-2 ${hovered || active ? 'scale-200 mt-16' : 'pop-huge hover:mt-16'} transition-all duration-500 ease-in-out cursor-pointer`}
        onClick={() => setActive(!active)}
        ...
        {hovered == false && <p className="text-lg text-[#7c6f57] mb-12 italic pop-big">
